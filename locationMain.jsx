...
import { faLocationDot, faNavicon } from '@fortawesome/free-solid-svg-icons';
        ...
        <Container fluid>
            <Row>
                <Col>
                    ...
                    <br />
                    <h4><strong>البحث عن المحلات</strong></h4>               <hr />     </Col>
            </Row>
            ...
            <Row className="search-bar">
                ...
                <Col xs={2}>
                    <p> <FontAwesomeIcon icon={faSearch} className="me-2" /><strong>البحث عن أقرب المحلات إليك
                    </strong>               
                    </p>
                </Col>

                <Col xs={1}>                 <FontAwesomeIcon icon={faLocationDot} className="me-2" />
